...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5164e0977d6a1f0dcc6cbcb1bbb1d02579f1d73e7a75108683293b13db2e343e.js',function(){input.required=false;search();});}
