...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3edbf936ba892a97ae0e4bc632528335d91d3ae13d111a13288eff8d69a21d65.js',function(){input.required=false;search();});}
