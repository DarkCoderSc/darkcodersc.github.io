...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3465d51b657c207d5639a1cd812d380ed0ab5d07d0873fae3eb8d50754787c07.js',function(){input.required=false;search();});}
