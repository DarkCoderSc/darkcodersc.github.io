...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.55e5cb861ef75a0f1cd4e8e9f423a57265c53478dbd65818875bac748aea40c9.js',function(){input.required=false;search();});}
