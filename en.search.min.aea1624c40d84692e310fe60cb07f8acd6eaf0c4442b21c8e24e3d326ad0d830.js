...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.25a31b3b37ee835b9b8ba696208c092124361269c57339864205731439e8f7fb.js',function(){input.required=false;search();});}
