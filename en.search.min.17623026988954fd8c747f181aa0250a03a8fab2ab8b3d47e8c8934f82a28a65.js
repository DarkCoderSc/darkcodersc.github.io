...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f7dcb40a3fff18fb88f094f4a2562591be1c4ea9af952736960d4899314776fe.js',function(){input.required=false;search();});}
