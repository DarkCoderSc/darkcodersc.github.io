...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f9a62424de68d994a2134c8dfed94bceddbc5ac56d2fdeee22665e094cd25fe3.js',function(){input.required=false;search();});}
